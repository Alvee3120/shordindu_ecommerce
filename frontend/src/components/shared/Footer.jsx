    ...
    <footer className="relative overflow-hidden bg-(--primary) text-white">
      <div className="mx-auto max-w-7xl px-6 py-16 sm:px-8">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1.3fr_1fr_1fr_1.2fr]">
          ...
          {/* Column 2: Category */}
          <div>
            <h4 className="mb-5 text-xs font-semibold tracking-widest text-gray-400">
              CATEGORY
            </h4>
      ...
      <div className="pointer-events-none font-sora select-none overflow-hidden pb-2">
        <p className="-mb-4 translate-x-[-2%] text-center text-[18vw] leading-none font-bold whitespace-nowrap text-white/30 sm:text-[15vw]">
          shordindu.
        </p>
      </div>
    </footer>
